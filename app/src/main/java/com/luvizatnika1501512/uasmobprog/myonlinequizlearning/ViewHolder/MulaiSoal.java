...
public class MulaiSoal extends AppCompatActivity implements View.OnClickListener {
    ...
    int index=0,score=0,wrong=0,thisQuestion=0,totalQuestion,correctAnswer;
    ...
    TextView txtScore,txtWrong,txtQuestionNum,question_text;
...
//                finish();
            ...
            txtWrong.setText(String.format("%d",wrong));
        }
    }
